...
(__version__, ) = re.findall("__version__.*\s*=\s*[']([^']+)[']",
                             open('budgetlib/__init__.py').read())
...
setup(
    name='budgetlib',
    version=__version__,
    description='Библиотека работы с данными сводной бюджетной росписи',
    long_description=readme + '\n\n' + history,
    author='Ivan Begtin',
    author_email='ivan@begtin.tech',
    url='https://code.ach.gov.ru/labs/budgetlib',
